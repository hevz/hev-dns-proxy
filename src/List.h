 ...
 */
     ...
     */
        ...
        public:
            ...
            template <typename V>
            explicit _ListIterator (const V &rhs) : mpNode (rhs.mpNode)
            {
            }
     ...
     */
        template <typename U, template <class> class CL,
                  template <class> class CR>
        ptrdiff_t distance (_ListIterator<U, CL> first,
                            _ListIterator<U, CR> last) const
        {
            ptrdiff_t count = 0;
            while (first != last) {
                ++first;
